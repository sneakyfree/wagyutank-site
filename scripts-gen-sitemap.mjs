...
const staticRoutes = [
  ...
  ["/news/", 0.9, "hourly"], ["/market/", 0.8, "daily"], ["/sales/", 0.8, "weekly"],
...
try {
  ...
  for (const a of animals) if (a.registration_no)
    urls.push(`  <url><loc>${BASE}/animal/?reg=${encodeURIComponent(a.registration_no)}</loc><lastmod>${now}</lastmod><changefreq>monthly</changefreq><priority>0.7</priority></url>`);
